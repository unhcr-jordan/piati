(function(d3, global, undefined){
    ...
    function progressBar(elSelector, data, valueFn, labelFn, textFn){
        ...
        var width = parseInt(d3.select(elSelector).style('width')) - margin.left - margin.right;
        var height = parseInt(d3.select(elSelector).style('height')) - margin.top - margin.bottom;
        var size = 30;
        var thickSize = 3;
